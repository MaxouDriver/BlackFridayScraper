...
export class init1606203150035 implements MigrationInterface {
    name = 'init1606203150035'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "site" ADD CONSTRAINT "FK_b2e5d149c55f36e2c6010b5160b" FOREIGN KEY ("productId") REFERENCES "product"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
